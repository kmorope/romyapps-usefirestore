...
export default defineConfig({
  title: "@romy/usefirestore",
  description: "Headless Firestore hooks powered by TanStack Query",
  base: "/romy-usefirestore/",
  themeConfig: {
    logo: "🔥",
    nav: [
      { text: "Home", link: "/" },
      { text: "npm", link: "https://www.npmjs.com/package/@romy/usefirestore" },
      { text: "GitHub", link: "https://github.com/kmorope/romy-usefirestore" },
    ],
    sidebar: [
      {
    ...
    socialLinks: [
      { icon: "github", link: "https://github.com/kmorope/romy-usefirestore" },
    ],
    footer: {
